"""dfw_transportation_27442 URL Configuration
...
admin.site.site_header = "DFW Transportation"
admin.site.site_title = "DFW Transportation Admin Portal"
admin.site.index_title = "DFW Transportation Admin"

# swagger
api_info = openapi.Info(
    title="DFW Transportation API",
    default_version="v1",
    description="API documentation for DFW Transportation App",
)
